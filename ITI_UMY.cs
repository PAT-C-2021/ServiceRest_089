...
namespace ServiceRest_20190140089_Prasetyo_Nur_Hidayat
{
    ...
    // You can add XSD files into the project. After building the project, you can directly use the data types defined there, with the namespace "ServiceRest_20190140089_Prasetyo_Nur_Hidayat.ContractType".
    [DataContract]
